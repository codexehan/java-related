...
@Slf4j
public class ProductFinalStatusConsumer extends DataConsumer {
    public ProductFinalStatusConsumer(String bootstrapServer, String groupId, String topic, Deserializer keyJsonSerde, Deserializer valueJsonSerde, PipelineKafkaOffsetService pipelineKafkaOffsetService) {
        super(bootstrapServer, groupId, topic, keyJsonSerde, valueJsonSerde, pipelineKafkaOffsetService);
    }

    @Override
    public void consume(){
        log.info("---------------Consume Product Final Status Start------------------");
        ...
        while (true) {
            ...
            for (ConsumerRecord<Long, String> record : records) {
                ...
                if(record.value()!=null) {
                    ...
                    productUpdateMap.put(record.key(), Boolean.valueOf(record.value()));
                    ...
                    log.error("product final status consumer format error");
                }
            }
