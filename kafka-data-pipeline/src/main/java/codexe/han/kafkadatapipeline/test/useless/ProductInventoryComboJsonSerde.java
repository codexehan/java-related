...
public class ProductInventoryComboJsonSerde<T> implements Serializer<T>, Deserializer<T>, Serde<T> {
    ...
    public T deserialize(final String topic, final byte[] data) {
        ...
        try {
            return (T) OBJECT_MAPPER.readValue(data, ProductInventoryComboDTO.class);
