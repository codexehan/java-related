...
public class JedisSlotBasedConnectionHandler extends JedisClusterConnectionHandler {
  ...
  public JedisSlotBasedConnectionHandler(Set<redis.clients.jedis.HostAndPort> nodes,
  ...
  public JedisSlotBasedConnectionHandler(Set<redis.clients.jedis.HostAndPort> nodes, GenericObjectPoolConfig poolConfig, int connectionTimeout, int soTimeout, String password) {
    super(nodes, poolConfig, connectionTimeout, soTimeout, password);
  }

  public JedisSlotBasedConnectionHandler(Set<redis.clients.jedis.HostAndPort> nodes, GenericObjectPoolConfig poolConfig, int connectionTimeout, int soTimeout, String password, String clientName) {
  ...
  public redis.clients.jedis.Jedis getConnection() {
    ...
    List<redis.clients.jedis.JedisPool> pools = cache.getShuffledNodesPool();

    for (redis.clients.jedis.JedisPool pool : pools) {
