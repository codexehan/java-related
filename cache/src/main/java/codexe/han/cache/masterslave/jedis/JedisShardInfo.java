...
public class JedisShardInfo extends ShardInfo<redis.clients.jedis.Jedis> {
  ...
  public JedisShardInfo(String host) {
    ...
    if (JedisURIHelper.isValid(uri)) {
      ...
      this.host = host;
      this.port = redis.clients.jedis.Protocol.DEFAULT_PORT;
    }
  }
  ...
  public JedisShardInfo(String host, String name) {
    this(host, redis.clients.jedis.Protocol.DEFAULT_PORT, name);
  }
  ...
  public JedisShardInfo(String host, int port) {
    this(host, port, redis.clients.jedis.Protocol.DEFAULT_TIMEOUT);
  }

  public JedisShardInfo(String host, int port, boolean ssl) {
    this(host, port, redis.clients.jedis.Protocol.DEFAULT_TIMEOUT, ssl);
  }

  public JedisShardInfo(String host, int port, boolean ssl, SSLSocketFactory sslSocketFactory,
      SSLParameters sslParameters, HostnameVerifier hostnameVerifier) {
    this(host, port, redis.clients.jedis.Protocol.DEFAULT_TIMEOUT, ssl, sslSocketFactory, sslParameters,
        hostnameVerifier);
  }

  public JedisShardInfo(String host, int port, String name) {
    this(host, port, redis.clients.jedis.Protocol.DEFAULT_TIMEOUT, name);
  }

  public JedisShardInfo(String host, int port, String name, boolean ssl) {
    this(host, port, redis.clients.jedis.Protocol.DEFAULT_TIMEOUT, name, ssl);
  }
  ...
  @Override
  public redis.clients.jedis.Jedis createResource() {
