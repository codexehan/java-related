...
public class BinaryJedisCluster implements BinaryJedisClusterCommands,
  ...
  public BinaryJedisCluster(Set<redis.clients.jedis.HostAndPort> nodes, int timeout) {
    this(nodes, timeout, DEFAULT_MAX_ATTEMPTS, new GenericObjectPoolConfig());
  }

  public BinaryJedisCluster(Set<redis.clients.jedis.HostAndPort> nodes) {
    this(nodes, DEFAULT_TIMEOUT);
  }

  public BinaryJedisCluster(Set<redis.clients.jedis.HostAndPort> jedisClusterNode, int timeout, int maxAttempts,
  ...
  public BinaryJedisCluster(Set<redis.clients.jedis.HostAndPort> jedisClusterNode, int connectionTimeout,
  ...
  public BinaryJedisCluster(Set<redis.clients.jedis.HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout, int maxAttempts, String password, GenericObjectPoolConfig poolConfig) {
    this.connectionHandler = new JedisSlotBasedConnectionHandler(jedisClusterNode, poolConfig,
            connectionTimeout, soTimeout, password);
    this.maxAttempts = maxAttempts;
  }

  public BinaryJedisCluster(Set<redis.clients.jedis.HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout, int maxAttempts, String password, String clientName, GenericObjectPoolConfig poolConfig) {
    this.connectionHandler = new JedisSlotBasedConnectionHandler(jedisClusterNode, poolConfig,
  ...
  public redis.clients.jedis.Jedis getConnectionFromSlot(int slot) {
  ...
  public List<byte[]> hmget(final byte[] key, final byte[]... fields) {
    return new JedisClusterCommand<List<byte[]>>(connectionHandler, maxAttempts) {
      @Override
      public List<byte[]> execute(redis.clients.jedis.Jedis connection) {
  ...
  public Set<byte[]> hkeys(final byte[] key) {
    return new JedisClusterCommand<Set<byte[]>>(connectionHandler, maxAttempts) {
      @Override
      public Set<byte[]> execute(redis.clients.jedis.Jedis connection) {
  ...
  public Collection<byte[]> hvals(final byte[] key) {
    return new JedisClusterCommand<Collection<byte[]>>(connectionHandler, maxAttempts) {
      @Override
      public Collection<byte[]> execute(redis.clients.jedis.Jedis connection) {
  ...
  public Map<byte[], byte[]> hgetAll(final byte[] key) {
    return new JedisClusterCommand<Map<byte[], byte[]>>(connectionHandler, maxAttempts) {
      @Override
      public Map<byte[], byte[]> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public List<byte[]> sort(final byte[] key, final redis.clients.jedis.SortingParams sortingParameters) {
    return new JedisClusterCommand<List<byte[]>>(connectionHandler, maxAttempts) {
      @Override
      public List<byte[]> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public Set<redis.clients.jedis.Tuple> zrevrangeByScoreWithScores(final byte[] key, final double max,
  ...
  @Override
  public Set<redis.clients.jedis.Tuple> zrevrangeByScoreWithScores(final byte[] key, final byte[] max,
  ...
  @Override
  public Long zinterstore(final byte[] dstkey, final redis.clients.jedis.ZParams params, final byte[]... sets) {
    byte[][] wholeKeys = KeyMergeUtil.merge(dstkey, sets);
  ...
  @Override
  public void subscribe(final redis.clients.jedis.BinaryJedisPubSub jedisPubSub, final byte[]... channels) {
  ...
  @Override
  public List<redis.clients.jedis.GeoCoordinate> geopos(final byte[] key, final byte[]... members) {
    return new JedisClusterCommand<List<redis.clients.jedis.GeoCoordinate>>(connectionHandler, maxAttempts) {
      @Override
  ...
  @Override
  public List<redis.clients.jedis.GeoRadiusResponse> georadius(final byte[] key, final double longitude,
                                                               final double latitude, final double radius, final redis.clients.jedis.GeoUnit unit) {
    return new JedisClusterCommand<List<redis.clients.jedis.GeoRadiusResponse>>(connectionHandler, maxAttempts) {
      @Override
      public List<redis.clients.jedis.GeoRadiusResponse> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public List<redis.clients.jedis.GeoRadiusResponse> georadiusReadonly(final byte[] key, final double longitude,
                                                                       final double latitude, final double radius, final redis.clients.jedis.GeoUnit unit) {
    return new JedisClusterCommand<List<redis.clients.jedis.GeoRadiusResponse>>(connectionHandler, maxAttempts) {
      @Override
      public List<redis.clients.jedis.GeoRadiusResponse> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public List<redis.clients.jedis.GeoRadiusResponse> georadiusByMember(final byte[] key, final byte[] member,
  ...
  @Override
  public List<redis.clients.jedis.GeoRadiusResponse> georadiusByMemberReadonly(final byte[] key, final byte[] member,
                                                                               final double radius, final redis.clients.jedis.GeoUnit unit) {
    return new JedisClusterCommand<List<redis.clients.jedis.GeoRadiusResponse>>(connectionHandler, maxAttempts) {
      @Override
      public List<redis.clients.jedis.GeoRadiusResponse> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public redis.clients.jedis.ScanResult<byte[]> scan(final byte[] cursor, final redis.clients.jedis.ScanParams params) {
    ...
    return new JedisClusterCommand<redis.clients.jedis.ScanResult<byte[]>>(connectionHandler, maxAttempts) {
      @Override
      public redis.clients.jedis.ScanResult<byte[]> execute(redis.clients.jedis.Jedis connection) {
  ...
  public redis.clients.jedis.ScanResult<Map.Entry<byte[], byte[]>> hscan(final byte[] key, final byte[] cursor) {
    return new JedisClusterCommand<redis.clients.jedis.ScanResult<Map.Entry<byte[], byte[]>>>(connectionHandler,
                                                                          maxAttempts) {
      @Override
      public redis.clients.jedis.ScanResult<Map.Entry<byte[], byte[]>> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public redis.clients.jedis.ScanResult<Map.Entry<byte[], byte[]>> hscan(final byte[] key, final byte[] cursor,
                                                                         final redis.clients.jedis.ScanParams params) {
    return new JedisClusterCommand<redis.clients.jedis.ScanResult<Map.Entry<byte[], byte[]>>>(connectionHandler,
                                                                          maxAttempts) {
      @Override
      public redis.clients.jedis.ScanResult<Map.Entry<byte[], byte[]>> execute(redis.clients.jedis.Jedis connection) {
  ...
  public redis.clients.jedis.ScanResult<redis.clients.jedis.Tuple> zscan(final byte[] key, final byte[] cursor) {
    return new JedisClusterCommand<redis.clients.jedis.ScanResult<redis.clients.jedis.Tuple>>(connectionHandler, maxAttempts) {
      @Override
      public redis.clients.jedis.ScanResult<redis.clients.jedis.Tuple> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public redis.clients.jedis.ScanResult<redis.clients.jedis.Tuple> zscan(final byte[] key, final byte[] cursor, final ScanParams params) {
    return new JedisClusterCommand<redis.clients.jedis.ScanResult<redis.clients.jedis.Tuple>>(connectionHandler, maxAttempts) {
      @Override
