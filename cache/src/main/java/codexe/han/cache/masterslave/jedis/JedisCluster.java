...
public class JedisCluster extends BinaryJedisCluster implements JedisClusterCommands,
  ...
  public JedisCluster(redis.clients.jedis.HostAndPort node) {
    this(Collections.singleton(node));
  }

  public JedisCluster(redis.clients.jedis.HostAndPort node, int timeout) {
    this(Collections.singleton(node), timeout);
  }

  public JedisCluster(redis.clients.jedis.HostAndPort node, int timeout, int maxAttempts) {
    this(Collections.singleton(node), timeout, maxAttempts);
  }

  public JedisCluster(redis.clients.jedis.HostAndPort node, final GenericObjectPoolConfig poolConfig) {
    this(Collections.singleton(node), poolConfig);
  }

  public JedisCluster(redis.clients.jedis.HostAndPort node, int timeout, final GenericObjectPoolConfig poolConfig) {
  ...
  public JedisCluster(redis.clients.jedis.HostAndPort node, int connectionTimeout, int soTimeout,
  ...
  public JedisCluster(Set<redis.clients.jedis.HostAndPort> nodes) {
    this(nodes, DEFAULT_TIMEOUT);
  }

  public JedisCluster(Set<redis.clients.jedis.HostAndPort> nodes, int timeout) {
    this(nodes, timeout, DEFAULT_MAX_ATTEMPTS);
  }

  public JedisCluster(Set<redis.clients.jedis.HostAndPort> nodes, int timeout, int maxAttempts) {
    this(nodes, timeout, maxAttempts, new GenericObjectPoolConfig());
  }

  public JedisCluster(Set<redis.clients.jedis.HostAndPort> nodes, final GenericObjectPoolConfig poolConfig) {
    this(nodes, DEFAULT_TIMEOUT, DEFAULT_MAX_ATTEMPTS, poolConfig);
  }

  public JedisCluster(Set<redis.clients.jedis.HostAndPort> nodes, int timeout, final GenericObjectPoolConfig poolConfig) {
    this(nodes, timeout, DEFAULT_MAX_ATTEMPTS, poolConfig);
  }

  public JedisCluster(Set<redis.clients.jedis.HostAndPort> jedisClusterNode, int timeout, int maxAttempts,
                      final GenericObjectPoolConfig poolConfig) {
    super(jedisClusterNode, timeout, maxAttempts, poolConfig);
  }

  public JedisCluster(Set<redis.clients.jedis.HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout,
                      int maxAttempts, final GenericObjectPoolConfig poolConfig) {
  ...
  public String set(final String key, final String value) {
    return new JedisClusterCommand<String>(connectionHandler, maxAttempts) {
      @Override
      public String execute(redis.clients.jedis.Jedis connection) {
  ...
  public Boolean exists(final String key) {
    return new JedisClusterCommand<Boolean>(connectionHandler, maxAttempts) {
      @Override
      public Boolean execute(redis.clients.jedis.Jedis connection) {
  ...
  public Long exists(final String... keys) {
    return new JedisClusterCommand<Long>(connectionHandler, maxAttempts) {
      @Override
      public Long execute(redis.clients.jedis.Jedis connection) {
  ...
  public byte[] dump(final String key) {
    return new JedisClusterCommand<byte[]>(connectionHandler, maxAttempts) {
      @Override
      public byte[] execute(redis.clients.jedis.Jedis connection) {
  ...
  public Double incrByFloat(final String key, final double increment) {
    return new JedisClusterCommand<Double>(connectionHandler, maxAttempts) {
      @Override
      public Double execute(redis.clients.jedis.Jedis connection) {
  ...
  public List<String> hmget(final String key, final String... fields) {
    return new JedisClusterCommand<List<String>>(connectionHandler, maxAttempts) {
      @Override
      public List<String> execute(redis.clients.jedis.Jedis connection) {
  ...
  public Set<String> hkeys(final String key) {
    return new JedisClusterCommand<Set<String>>(connectionHandler, maxAttempts) {
      @Override
      public Set<String> execute(redis.clients.jedis.Jedis connection) {
  ...
  public Map<String, String> hgetAll(final String key) {
    return new JedisClusterCommand<Map<String, String>>(connectionHandler, maxAttempts) {
      @Override
      public Map<String, String> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public Set<redis.clients.jedis.Tuple> zrangeWithScores(final String key, final long start, final long stop) {
    return new JedisClusterCommand<Set<redis.clients.jedis.Tuple>>(connectionHandler, maxAttempts) {
      @Override
      public Set<redis.clients.jedis.Tuple> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public Set<redis.clients.jedis.Tuple> zrevrangeWithScores(final String key, final long start, final long stop) {
    return new JedisClusterCommand<Set<redis.clients.jedis.Tuple>>(connectionHandler, maxAttempts) {
      @Override
      public Set<redis.clients.jedis.Tuple> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public Set<redis.clients.jedis.Tuple> zrangeByScoreWithScores(final String key, final String min, final String max) {
    return new JedisClusterCommand<Set<redis.clients.jedis.Tuple>>(connectionHandler, maxAttempts) {
      @Override
      public Set<redis.clients.jedis.Tuple> execute(redis.clients.jedis.Jedis connection) {
        return connection.zrangeByScoreWithScores(key, min, max);
  ...
  @Override
  public Set<redis.clients.jedis.Tuple> zrevrangeByScoreWithScores(final String key, final String max, final String min) {
    return new JedisClusterCommand<Set<redis.clients.jedis.Tuple>>(connectionHandler, maxAttempts) {
      @Override
      public Set<redis.clients.jedis.Tuple> execute(redis.clients.jedis.Jedis connection) {
        return connection.zrevrangeByScoreWithScores(key, max, min);
  ...
  @Override
  public Set<redis.clients.jedis.Tuple> zrevrangeByScoreWithScores(final String key, final double max,
  ...
  @Override
  public Set<redis.clients.jedis.Tuple> zrevrangeByScoreWithScores(final String key, final String max,
  ...
  @Override
  public redis.clients.jedis.ScanResult<String> scan(final String cursor, final ScanParams params) {
    ...
    return new JedisClusterCommand<redis.clients.jedis.ScanResult<String>>(connectionHandler, maxAttempts) {
      @Override
      public redis.clients.jedis.ScanResult<String> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public redis.clients.jedis.ScanResult<Entry<String, String>> hscan(final String key, final String cursor) {
    return new JedisClusterCommand<redis.clients.jedis.ScanResult<Entry<String, String>>>(connectionHandler,
                                                                      maxAttempts) {
      @Override
      public redis.clients.jedis.ScanResult<Entry<String, String>> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public redis.clients.jedis.ScanResult<String> sscan(final String key, final String cursor) {
    return new JedisClusterCommand<redis.clients.jedis.ScanResult<String>>(connectionHandler, maxAttempts) {
      @Override
      public redis.clients.jedis.ScanResult<String> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public redis.clients.jedis.ScanResult<redis.clients.jedis.Tuple> zscan(final String key, final String cursor) {
    return new JedisClusterCommand<redis.clients.jedis.ScanResult<redis.clients.jedis.Tuple>>(connectionHandler, maxAttempts) {
      @Override
      public ScanResult<Tuple> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public Long zinterstore(final String dstkey, final redis.clients.jedis.ZParams params, final String... sets) {
  ...
  @Override
  public void subscribe(final redis.clients.jedis.JedisPubSub jedisPubSub, final String... channels) {
    new JedisClusterCommand<Integer>(connectionHandler, maxAttempts) {
      @Override
      public Integer execute(redis.clients.jedis.Jedis connection) {
  ...
  public Object eval(final String script, final int keyCount, final String... params) {
    return new JedisClusterCommand<Object>(connectionHandler, maxAttempts) {
      @Override
      public Object execute(redis.clients.jedis.Jedis connection) {
  ...
  public List<Boolean> scriptExists(final String sampleKey, final String... sha1) {
    return new JedisClusterCommand<List<Boolean>>(connectionHandler, maxAttempts) {
      @Override
      public List<Boolean> execute(redis.clients.jedis.Jedis connection) {
        return connection.scriptExists(sha1);
      }
    }.run(sampleKey);
  }
  ...
  public List<GeoCoordinate> geopos(final String key, final String... members) {
    return new JedisClusterCommand<List<GeoCoordinate>>(connectionHandler, maxAttempts) {
      @Override
      public List<GeoCoordinate> execute(redis.clients.jedis.Jedis connection) {
  ...
  public List<GeoRadiusResponse> georadius(final String key, final double longitude,
      final double latitude, final double radius, final redis.clients.jedis.GeoUnit unit) {
    return new JedisClusterCommand<List<GeoRadiusResponse>>(connectionHandler, maxAttempts) {
      @Override
      public List<GeoRadiusResponse> execute(redis.clients.jedis.Jedis connection) {
  ...
  @Override
  public List<GeoRadiusResponse> georadius(final String key, final double longitude,
                                           final double latitude, final double radius, final redis.clients.jedis.GeoUnit unit, final GeoRadiusParam param) {
    return new JedisClusterCommand<List<GeoRadiusResponse>>(connectionHandler, maxAttempts) {
      @Override
      public List<GeoRadiusResponse> execute(redis.clients.jedis.Jedis connection) {
  ...
  public List<Long> bitfield(final String key, final String... arguments) {
    return new JedisClusterCommand<List<Long>>(connectionHandler, maxAttempts) {
      @Override
      public List<Long> execute(redis.clients.jedis.Jedis connection) {
  ...
  public StreamEntryID xadd(final String key, final StreamEntryID id, final Map<String, String> hash) {
    return new JedisClusterCommand<StreamEntryID>(connectionHandler, maxAttempts) {
      @Override
      public StreamEntryID execute(redis.clients.jedis.Jedis connection) {
  ...
  public List<StreamEntry> xrange(final String key, final StreamEntryID start, final StreamEntryID end, final int count) {
    return new JedisClusterCommand<List<StreamEntry>>(connectionHandler, maxAttempts) {
      @Override
      public List<StreamEntry> execute(redis.clients.jedis.Jedis connection) {
  ...
  public List<Entry<String, List<StreamEntry>>> xread(final int count, final long block, final Entry<String, StreamEntryID>... streams) {
    ...
    return new JedisClusterCommand<List<Entry<String, List<StreamEntry>>>>(connectionHandler, maxAttempts) {
      @Override
      public List<Entry<String, List<StreamEntry>>> execute(redis.clients.jedis.Jedis connection) {
  ...
  public List<StreamPendingEntry> xpending(final String key, final String groupname, final StreamEntryID start, final StreamEntryID end, final int count,
    ...
    return new JedisClusterCommand<List<StreamPendingEntry>>(connectionHandler, maxAttempts) {
      @Override
      public List<StreamPendingEntry> execute(redis.clients.jedis.Jedis connection) {
