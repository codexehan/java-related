...
public class ShardedJedis extends BinaryShardedJedis implements JedisCommands, Closeable {
  ...
  public String echo(final String string) {
    redis.clients.jedis.Jedis j = getShard(string);
  ...
  @Override
  public Set<redis.clients.jedis.Tuple> zrangeByScoreWithScores(final String key, final double min, final double max, final int offset,
                                                                final int count) {
    redis.clients.jedis.Jedis j = getShard(key);
  ...
  @Override
  public Set<redis.clients.jedis.Tuple> zrevrangeByScoreWithScores(final String key, final double max, final double min, final int offset,
                                                                   final int count) {
    redis.clients.jedis.Jedis j = getShard(key);
  ...
  @Override
  public Set<redis.clients.jedis.Tuple> zrangeByScoreWithScores(final String key, final String min, final String max, final int offset,
                                                                final int count) {
    redis.clients.jedis.Jedis j = getShard(key);
    return j.zrangeByScoreWithScores(key, min, max, offset, count);
  }
  ...
  @Override
  public Set<redis.clients.jedis.Tuple> zrevrangeByScoreWithScores(final String key, final String max, final String min, final int offset,
                                                                   final int count) {
    redis.clients.jedis.Jedis j = getShard(key);
    return j.zrevrangeByScoreWithScores(key, max, min, offset, count);
  }
  ...
  @Override
  public redis.clients.jedis.ScanResult<Entry<String, String>> hscan(final String key, final String cursor, final redis.clients.jedis.ScanParams params) {
    redis.clients.jedis.Jedis j = getShard(key);
  ...
  @Override
  public redis.clients.jedis.ScanResult<Tuple> zscan(final String key, final String cursor, final redis.clients.jedis.ScanParams params) {
    redis.clients.jedis.Jedis j = getShard(key);
  ...
  @Override
  public Double geodist(final String key, final String member1, final String member2, final redis.clients.jedis.GeoUnit unit) {
    redis.clients.jedis.Jedis j = getShard(key);
